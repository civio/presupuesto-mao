...
expenses_mapping = {
    '2019': {'ic_code': 0, 'fc_code': 1, 'full_ec_code': 3, 'description': 5, 'forecast_amount': 7, 'actual_amount': None},
    '2018': {'ic_code': 3, 'fc_code': 4, 'full_ec_code': 5, 'description': 6, 'forecast_amount': 7, 'actual_amount': 10},
...
income_mapping = {
    '2019': {'full_ec_code': 0, 'description': 2, 'forecast_amount': 4, 'actual_amount': None},
    '2018': {'full_ec_code': 2, 'description': 3, 'forecast_amount': 4, 'actual_amount': 8},
...
programme_mapping = {
    ...
    '1550': '1532',     # Vies públiques
    '1620': '1621',     # R.S.U. i neteja viària
    '1690': '1711',     # Serveis comuns de ciutat i medi ambient -> Ciutat i medi ambient
...
programme_mapping_changes = {
    # old programme: new programme
    '1624': '1532',     # Vías públicas
    '3120': '2311',     # R.G.A.
    '3340': '3300',     # Cultura
    '1651': '1711',     # Ciudad y medio ambiente
}
...
class MaoBudgetLoader(SimpleBudgetLoader):
    ...
    def parse_item(self, filename, line):
        ...
        if is_expense:
            ...
            # For 2015 and following budgets there are still some programme codes we need to amend, due to some classification changes
            if int(self.year) >= 2015:
                fc_code = programme_mapping_changes.get(fc_code, fc_code)
